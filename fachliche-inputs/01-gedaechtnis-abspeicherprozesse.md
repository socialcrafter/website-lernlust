...
Unser Gedächtnis arbeitet in drei Stufen, die für das Design von Lern-Apps zentral sind:
...
## Zwei Filter auf dem Weg ins Langzeitgedächtnis
...
- **Der leichte Weg**: Informationen, die starkes Interesse, Motivation oder Gefühle wecken, passieren die Filter quasi automatisch und gelangen leicht ins Langzeitgedächtnis.
- **Der beschwerliche Weg**: Bei normalem Schulstoff, der kaum Interesse oder Motivation weckt, ist bewusstes, aktives Wiederholen nötig. Dies ist beim schulischen Lernen der Regelfall.

## Konsequenzen für die App-Gestaltung

- Informationen müssen in kleinen, gut strukturierten Einheiten dargeboten werden, um das begrenzte Arbeitsgedächtnis nicht zu überfordern.
- Der visuelle Kanal sollte bevorzugt genutzt werden (höchste Aufnahmekapazität).
- Positive Emotionen und spielerische Elemente können helfen, den «leichten Weg» ins Langzeitgedächtnis zu aktivieren.
- Wiederholungsfunktionen sind unverzichtbar, da der beschwerliche Weg des Abspeicherns beim Lernen dominiert.
