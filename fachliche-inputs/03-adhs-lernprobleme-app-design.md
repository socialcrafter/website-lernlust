...
- **Impulsivität**: Tendenz, ohne nachzudenken zu reagieren. Kinder beginnen Aufgaben, bevor sie die Anleitung verstanden haben, und handeln nach dem «Versuch-und-Irrtum-Prinzip».
...
- Die Motivation bei «langweiligen» Inhalten sinkt schnell.
- Häufige Fehler steigern die Frustration.

### Lesen
Der Blick schweift ab, ist nicht auf die Zeile gerichtet. Blicksprünge verlaufen unkoordiniert, Buchstaben werden übersehen, Wortbilder nur schwer erkannt. Sinnentnahme ist oft gar nicht gegeben.

### Schreiben
Graphomotorische Schwierigkeiten, ungenügende Kraftdosierung, unleserliche Handschrift. Das Schreiben ist anstrengend, was die Motivation zusätzlich senkt.

### Rechnen
Kinder greifen auf fehlerhafte Strategien zurück (z.B. zählendes Rechnen statt Abruf), überfliegen Aufgabenstellungen und arbeiten nach Versuch und Irrtum.

### Emotionale Selbstregulation
Geringe Frustrationstoleranz, überschiessende Gefühlsreaktionen. Negative Gedanken als «Energiekiller»: «Das schaffe ich sowieso nicht» oder «Beim letzten Mal hat es auch nicht geklappt.»

## Der Teufelskreis Lernstörungen

Born/Oehler beschreiben einen typischen Teufelskreis: Leistungsprobleme führen zu psychischen Problemen und Verhaltensauffälligkeiten, diese führen zu Beeinträchtigungen des Lebens- und Berufsweges, welche wiederum zu weiteren psychischen Problemen führen.
...
- **Strukturierung von aussen anbieten**: Klare Abläufe, Zeitangaben, nächste Schritte sichtbar machen.
